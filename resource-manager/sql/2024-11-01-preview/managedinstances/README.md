...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstances` Documentation

The `managedinstances` SDK allows for interaction with Azure Resource Manager `sql` (API Version `2024-11-01-preview`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstances"
```
...
### Example Usage: `ManagedInstancesClient.ReevaluateInaccessibleDatabaseState`

```go
ctx := context.TODO()
id := commonids.NewSqlManagedInstanceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceName")

if err := client.ReevaluateInaccessibleDatabaseStateThenPoll(ctx, id); err != nil {
	// handle the error
}
```
...
### Example Usage: `ManagedInstancesClient.ValidateAzureKeyVaultEncryptionKey`

```go
ctx := context.TODO()
id := commonids.NewSqlManagedInstanceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceName")

payload := managedinstances.ManagedInstanceValidateAzureKeyVaultEncryptionKeyRequest{
	// ...
}


if err := client.ValidateAzureKeyVaultEncryptionKeyThenPoll(ctx, id, payload); err != nil {
	// handle the error
}
```
