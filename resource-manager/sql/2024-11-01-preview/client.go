...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/backupshorttermretentionpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/blobauditing"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseadvancedthreatprotectionsettings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseadvisors"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseautomatictuning"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasecolumns"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseencryptionprotectorrevalidate"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseencryptionprotectorrevert"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseextensions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseoperations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaserecommendedactions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseschemas"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasesecurityalertpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasesqlvulnerabilityassessmentbaselines"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasesqlvulnerabilityassessmentexecutescan"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasesqlvulnerabilityassessmentrulebaselines"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasesqlvulnerabilityassessmentscanresult"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasesqlvulnerabilityassessmentscans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasesqlvulnerabilityassessmentssettings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasetables"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databaseusages"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasevulnerabilityassessmentrulebaselines"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasevulnerabilityassessments"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/databasevulnerabilityassessmentscans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/datamaskingpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/datamaskingrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/datawarehouseuseractivities"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/deletedservers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/distributedavailabilitygroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/elasticpooloperations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/elasticpools"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/encryptionprotectors"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/endpointcertificates"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/failovergroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/firewallrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/geobackuppolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/instancefailovergroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/instancepooloperations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/instancepools"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/ipv6firewallrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobagents"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobcredentials"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobexecutions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobprivateendpoints"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobs"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobstepexecutions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobsteps"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobtargetexecutions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobtargetgroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/jobversions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/ledgerdigestuploads"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/locationcapabilities"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/longtermretentionbackups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/longtermretentionmanagedinstancebackups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/longtermretentionpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/maintenancewindowoptions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/maintenancewindows"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedbackupshorttermretentionpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabaseadvancedthreatprotectionsettings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasecolumns"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasemoveoperations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasequeries"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabaserestoredetails"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabaseschemas"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasesecurityalertpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasesecurityevents"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasesensitivitylabels"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasetables"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasetransparentdataencryption"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasevulnerabilityassessmentrulebaselines"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasevulnerabilityassessments"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/manageddatabasevulnerabilityassessmentscans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstanceadministrators"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstanceadvancedthreatprotectionsettings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstanceazureadonlyauthentications"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstancedtcs"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstanceencryptionprotectors"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstancekeys"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstancelongtermretentionpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstanceoperations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstanceprivateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstanceprivatelinkresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstances"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstancetdecertificates"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedinstancevulnerabilityassessments"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedledgerdigestuploads"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedrestorabledroppeddatabasebackupshorttermretentionpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedserverdnsaliases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedserversecurityalertpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/networksecurityperimeterconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/outboundfirewallrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/privateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/privatelinkresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/recoverabledatabases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/recoverablemanageddatabases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/replicationlinks"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/restorabledroppeddatabases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/restorabledroppedmanageddatabases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/restorepoints"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sensitivitylabels"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serveradvancedthreatprotectionsettings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serveradvisors"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverautomatictuning"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverazureadadministrators"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverazureadonlyauthentications"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverconfigurationoptions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverconnectionpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverdevopsaudit"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverdnsaliases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverkeys"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serveroperations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/servers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serversecurityalertpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/servertrustcertificates"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/servertrustgroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/serverusages"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/servervulnerabilityassessments"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sqlagent"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sqlvulnerabilityassessmentbaseline"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sqlvulnerabilityassessmentexecutescan"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sqlvulnerabilityassessmentrulebaseline"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sqlvulnerabilityassessmentscanresult"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sqlvulnerabilityassessmentscans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/sqlvulnerabilityassessmentssettings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/startstopmanagedinstanceschedules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/subscriptionusages"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/synapselinkworkspaces"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/syncagents"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/syncgroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/syncmembers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/tdecertificates"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/timezones"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/transparentdataencryptions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/usages"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/virtualclusters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/virtualnetworkrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/workloadclassifiers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/workloadgroups"
...
type Client struct {
	...
	InstancePoolOperations                                           *instancepooloperations.InstancePoolOperationsClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	instancePoolOperationsClient, err := instancepooloperations.NewInstancePoolOperationsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building InstancePoolOperations client: %+v", err)
	}
	configureFunc(instancePoolOperationsClient.Client)
	...
	return &Client{
		...
		InstancePoolOperations:                              instancePoolOperationsClient,
