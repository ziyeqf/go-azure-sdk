...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedrestorabledroppeddatabasebackupshorttermretentionpolicies` Documentation

The `managedrestorabledroppeddatabasebackupshorttermretentionpolicies` SDK allows for interaction with Azure Resource Manager `sql` (API Version `2024-11-01-preview`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2024-11-01-preview/managedrestorabledroppeddatabasebackupshorttermretentionpolicies"
```
...
```go
ctx := context.TODO()
id := managedrestorabledroppeddatabasebackupshorttermretentionpolicies.NewManagedInstanceRestorableDroppedDatabaseID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedInstanceName", "restorableDroppedDatabaseId")
